...
public class StorageProviderTests : BaseTests
{
  ...
  [Fact]
  public async Task CanUploadBase64Image()
  {
    var sut = GetSut();

    var result = await sut.UploadBase64Image(_img64, "/", "1/2020/12");
  ...
  {
    var logger = new Mock<ILogger<StorageProvider>>();
    ...
    var configuration = new ConfigurationBuilder()
       ...
       .Build();
    return new StorageProvider(logger.Object, httpClientFactory.Object, configuration);
  }
}
